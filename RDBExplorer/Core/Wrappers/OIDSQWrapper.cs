using RDBExplorer.Core.Formats.OIDSQ;
using System.Text.Json;
using System.Text.Json.Serialization;

namespace RDBExplorer.Core.Wrappers
{
    public class OIDSQWrapper : ResourceWrapper<OIDSQFile>
    {
        private readonly OIDSQParser _parser = new OIDSQParser();

        public override void Load(byte[] data)
        {
            _parser.Load(data);
            Model = _parser.OIDSQFile;
        }
